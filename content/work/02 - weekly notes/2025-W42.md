...
const meetings = dv.pages('"work/03 - meetings"')
  .where(p => {
    ...
    return d && d >= dv.date("2025-10-09") && d < dv.date("2025-10-15");
  })
...
⬅️ [[work/02 - weekly notes/2025-W42|Previous Week]] | 🟢 [[work/02 - weekly notes/2025-W42|This Week]] | ➡️ [[work/02 - weekly notes/2025-W42|Next Week]]
