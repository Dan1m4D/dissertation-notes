...
> ```dataviewjs
>const start = dv.date("2025-10-05");
>const end = dv.date("2025-10-12");
>
...
const meetings = dv.pages('"work/03 - meetings"')
  .where(p => {
    ...
    return d && d >= dv.date("2025-10-02") && d < dv.date("2025-10-08");
  })
...
- [[02 October 2025]]  <!-- Monday -->
- [[03 October 2025]]  <!-- Tuesday -->
- [[04 October 2025]]  <!-- Wednesday -->
- [[05 October 2025]]  <!-- Thursday -->
- [[06 October 2025]]  <!-- Friday -->

---

## 🔗 Navigation

⬅️ [[work/02 - weekly notes/2025-W41|Previous Week]] | 🟢 [[work/02 - weekly notes/2025-W41|This Week]] | ➡️ [[work/02 - weekly notes/2025-W41|Next Week]]
