...
> ```dataviewjs
>const start = dv.date("2025-10-18");
...
const meetings = dv.pages('"work/03 - meetings"')
  .where(p => {
    ...
    return d && d >= dv.date("2025-10-18") && d < dv.date("2025-10-24");
  })
...
⬅️ [[work/02 - weekly notes/2025-W42|Previous Week]] | 🟢 [[work/02 - weekly notes/2025-W43|This Week]] | ➡️ [[work/02 - weekly notes/2025-W43|Next Week]]
